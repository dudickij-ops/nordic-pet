...
export type DatabaseCommand = {
   ...
   * Проверяется по тому, что на самом деле достижимо из её сценария.
   */
  outsideWorld: string[]
...
/** Внешние миры и модули, которыми в них ходят. */
export const OUTSIDE_WORLDS: Record<string, string[]> = {
  google: ['google-auth-library'],
}

/** Что команде можно всегда: драйвер базы. Всё прочее объявляется внешним миром. */
export const ALWAYS_ALLOWED = ['pg']
