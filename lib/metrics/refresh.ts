 ...
 * Десять минут: обновление в бою идёт около минуты (три шага, пять с половиной сотен строк), и
 * десять минут — запас в десять раз. Меньше — рискуем отобрать замок у работающего обновления;
