 ...
 * поиска сразу по всем дискам, — целиком и с условием: «You can search multiple corpora in a
 * single query; however, if the combined corpora is too large, the API might return incomplete
 * results». Наш вывод, помеченный как наш: условие про большое
