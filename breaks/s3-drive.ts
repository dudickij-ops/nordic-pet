 ...
 * поиска сразу по всем дискам: неполную выдачу. Мы эту цену принимаем — состав запроса взят
 * из готового примера руководства, — но не прячем: наш отказ на неполный список обязан
 * назвать общий диск и сказать, что делать. Без этого слома «громко» осталось бы обещанием.
 *
