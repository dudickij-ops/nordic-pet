...
export const BREAKS: Break[] = [
  ...
  {
    id: 'items-table-shrinks',
    claim: 'дать таблицам товаров сжиматься на узком экране ниже своих чисел',
    mustRedden: 'на узком экране таблицы товаров не уже порога и прокручиваются в карточке',
    file: 'app/globals.css',
    find: '  .items table {\n    min-width: calc(var(--page) * 2 / 3);\n  }\n',
    replace: '',
    tests: 'все',
  },
  {
