 ...
 *
 * **Откуда она взялась.** Числа вынуты из снимка `obychnyy.html`, уже лежащего в репозитории и
 * уже принятого владельцем: обратным разбором того, что печатают `money`, `percent`, `ratio` и
 * `count`. Обратный разбор мог ошибиться, и потому он не остаётся на веру: генератор сверяет
 * видимый текст каждого созданного файла с видимым текстом одноимённого файла в репозитории.
 * Расхождение в любой цифре красит эту сверку.
 *
