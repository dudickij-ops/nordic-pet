...
export default defineConfig({
  ...
  test: {
    ...
    testTimeout: 120_000,
    // Живых файлов проверок пять. Четыре из них пишут в базу по-настоящему, а в конце возвращают
    // её посевом — тем же файлом, который трогает все сырые таблицы разом; пятый
