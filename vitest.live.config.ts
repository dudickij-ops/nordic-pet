...
export default defineConfig({
  ...
  test: {
    ...
    testTimeout: 120_000,
    // Живых проверок стало две, и обе пишут в базу по-настоящему, а в конце возвращают
    // её посевом — тем же файлом, который трогает все сырые таблицы разом. Запущенные
    // вперемешку, они возвращали бы базу друг у друга под руками. Тот же порядок и по
    // той же причине, что в обычном наборе.
