 ...
 * разойтись с разностью показанных сумм на цент (в живой сверке марта — ровно так: 6 291,44 − 4 552,90 = 1 738,54
 * против прибыли 1 738,53, наш счёт). Здесь расхождение меняет знак: МД 200,00.
 */
