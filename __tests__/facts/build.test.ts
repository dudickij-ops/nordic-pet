...
describe('боевой путь', () => {
  ...
  // настоящей и создаёт вид, что место закрыто. Утверждение, ради которого она писалась —
  // «боевая проверка возвращает базу такой, какой нашла», — сейчас не сторожит никто, и
  // это названо в теле pull request отдельной строкой отложенных задач.
})
